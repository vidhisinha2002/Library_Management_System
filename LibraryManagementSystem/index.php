...
<tr><td class="labels">USN : </td><td><input type="text" name="sid" class="fields" size="25" placeholder="Enter USN" required="required" /></td></tr>
...
<tr><td colspan="2" align="center"><input type="submit" value="Sign In" style="cursor: pointer;" class="fields" /></td></tr>
</table>
</form>
<br />
<br />
